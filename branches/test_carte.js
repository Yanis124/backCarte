...
async function creation_marqueur(){
    ...
    var res=await fetch("https://data.opendatasoft.com/api/records/1.0/search/?dataset=accidents-corporels-de-la-circulation-millesime%40public&q=&rows=10000&refine.an=2012");
